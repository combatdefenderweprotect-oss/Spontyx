...
const SpontixSidebar = {
  ...
  // ── Player Navigation ──
  playerNav: [
    { label: 'Game Center', href: 'dashboard.html', icon: '<path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>' },
    ...
    { label: 'Fixtures', href: 'matches.html', icon: '<circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>' },

    { section: 'Game Modes' },
    { label: 'Leagues', href: 'leagues-hub.html', icon: '<path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/>' },
    { label: 'Arena', href: 'multiplayer.html', icon: '<polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>' },
    { label: 'Battle Royale', href: 'br-lobby.html', icon: '<circle cx="12" cy="10" r="8"/><path d="M12 18v4"/><path d="M8 22h8"/><circle cx="9" cy="9" r="1.5" fill="currentColor" stroke="none"/><circle cx="15" cy="9" r="1.5" fill="currentColor" stroke="none"/>', badge: 'BR', badgeStyle: 'background:linear-gradient(135deg,#FF6B6B,#E84545);' },
    ...
    { label: 'Clubs', href: 'clubs.html', icon: '<path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/><circle cx="19" cy="11" r="1.5" fill="currentColor" stroke="none"/>' },
    { label: 'Market', href: 'market.html', icon: '<line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/>', badge: '⚡', badgeStyle: 'background:linear-gradient(135deg,#A8E10C,#4ECDC4);color:#1A1A2E;' },

    { section: 'Play in Person' },
    { label: 'Find Venues', href: 'venues.html', icon: '<path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/>' },
    ...
    { label: 'Help',     href: 'help.html',            icon: '<circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/>' },
    { label: 'Support',  href: 'support.html',         icon: '<path d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 01-3.46 0"/>' },
  ],
    ...
    if (!isVenue) {
      (async function updateLeagueBadge() {
        try {
          ...
          // Inject/update badge on the Leagues link
          const leagueLink = document.querySelector('a[href="leagues-hub.html"]');
